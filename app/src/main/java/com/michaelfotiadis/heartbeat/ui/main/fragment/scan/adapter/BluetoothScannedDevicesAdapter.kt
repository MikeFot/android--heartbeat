package com.michaelfotiadis.heartbeat.ui.main.fragment.scan.adapter
...
class BluetoothScannedDevicesAdapter :
    ListAdapter<UiBondedDevice, BluetoothScannedDevicesAdapter.ViewHolder>(
        DiffCallback()
    ) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.run {
            ...
            rssiTextView.text = "RSSI: ${device.rssi}"
